...
def captureTestImage(settings, width, height):
    GPIO.setmode(GPIO.BCM) # Sets to use board pin numbering
    GPIO.setup(16,GPIO.OUT) # Sets pin 16 to output
    GPIO.output(16,True) # Writes a 1 to pin 16 and lights LED
...
def saveImage(settings, width, height, quality, diskSpaceToReserve):
	GPIO.setmode(GPIO.BCM) # Sets to use board pin numbering
	GPIO.setup(12,GPIO.OUT) # Sets pin 12 to output
	GPIO.output(12,True) # Writes a 1 to pin 12 and sounds buzzer
